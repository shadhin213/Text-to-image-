...
export const ImageHistoryView: React.FC<{ imageRecords: ImageRecord[] }> = ({ imageRecords }) => {
  ...
  return (
    <div>
      <div className="border-b border-slate-700 pb-4 mb-6">
        <h2 className="text-3xl font-bold tracking-tight text-white">Image History</h2>
